...
<div className="flex flex-wrap gap-1">
  <div
    ...
    title="primary"
  >
    <div className="text-primary-content text-sm font-bold">P</div>
  </div>
  <div
    className="bg-secondary flex aspect-square w-5 items-center justify-center rounded lg:w-6"
    title="secondary"
  >
    <div className="text-secondary-content text-sm font-bold">S</div>
  </div>
  <div
  ...
  <div
    ...
    title="neutral"
  >
    <div className="text-neutral-content text-sm font-bold">N</div>
  </div>
</div>
